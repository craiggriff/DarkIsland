...
PixelInputType main(VertexInputType input)
{
	...
	//output.color.w = 0.1f;// output.position.z; // min(((output.color.x + output.color.y + output.color.z)*((input.color.w*0.2f) + 0.1f)), input.color.w) * output.position.z;
	output.color.w = 1.0f;// min(((output.color.x + output.color.y + output.color.z)*((input.color.w*0.2f) + 0.1f)), input.color.w);
