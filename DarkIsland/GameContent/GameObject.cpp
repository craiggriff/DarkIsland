...
)
{
	...
	{
		m_hitMaterial->RenderSetup(graphics.m_deviceResources->GetD3DDeviceContext(), &constantBuffer);
	}
	else
	{
		m_normalMaterial->RenderSetup(graphics.m_deviceResources->GetD3DDeviceContext(), &constantBuffer);
	}
	graphics.m_deviceResources->GetD3DDeviceContext()->UpdateSubresource(primitiveConstantBuffer, 0, nullptr, &constantBuffer, 0, 0);

	m_mesh->Render(graphics.m_deviceResources->GetD3DDeviceContext());
}
